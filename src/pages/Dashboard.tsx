...
export default function Dashboard() {
  ...
  return (
     <div className="space-y-8 max-w-7xl">
      ...
      {/* Relatórios Section */}
      <div className="space-y-6 pt-8 pb-4 animate-fade-in-up stagger-6">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div>
            ...
            <p className="text-muted-foreground text-sm mt-1">
              Desempenho anual e preparação para o Imposto de Renda
            </p>
          </div>
          
          <Dialog>
            <DialogTrigger asChild>
              <Button variant="outline" className="gap-2 border-primary/20 hover:border-primary/50 text-foreground bg-card">
            ...
            <DialogContent className="sm:max-w-md bg-card border-border">
              ...
              <div className="flex justify-end pt-5 border-t border-border mt-2">
                <Button variant="default" className="w-full gap-2 text-white shadow-md hover:shadow-lg transition-all" onClick={() => alert("A exportação de dados para contabilidade estará disponível na próxima atualização.")}>
